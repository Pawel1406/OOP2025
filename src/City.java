...
public class City {
    ...
    public static int worstTimezoneFit(Object clock10, Object clock20) throws FileNotFoundException {
        Clock temp,temp1;
    ...
    public static void generateAnalogClockSvg(List<Map.Entry<String, City>> lista, AnalogClock zegar) throws IOException {
        Files.createDirectory(Paths.get("C:/C:\\Users\\platy\\OneDrive\\Pulpit\\materiały\\prace\\java\\kolokwium1_2024\\src\\"+zegar.toString()));
        for (int i = 0; i < lista.size(); i++) {
            zegar.setTime(Integer.parseInt(zegar.getHh()+lista.get(i).getKey()), zegar.getMm(), zegar.getSs(), zegar.getCity());
            zegar.toSvg(zegar.toString()+"/"+lista.get(i).getKey()+".svg");
        }
    }
